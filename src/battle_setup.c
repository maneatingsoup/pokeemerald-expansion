...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_ACE_TRAINER_NATHAN, TRAINER_GYM_LEADER_MYCELIAN, TRAINER_AROMA_LADY_TAYLOR, TRAINER_LADY_BRIANNA, TRAINER_RUNNER_JACK, ROUTE118),
};
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (trainerClass == TRAINER_CLASS_TEAM_HELIX)
        return B_TRANSITION_HELIX;
...
void PlayTrainerEncounterMusic(void)
{
        ...
        && sTrainerBattleMode != TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_MUSIC)
    {
        ...
        case TRAINER_ENCOUNTER_MUSIC_RICH:
            ...
            break;
        case TRAINER_ENCOUNTER_MUSIC_ACE:
