...
const u8 gText_ActivatedArumTwigBracelet[] = _("{PLAYER} took out the {STR_VAR_2}.\nWild pokémon will be repelled.{PAUSE_UNTIL_PRESS}");
const u8 gText_DeactivatedArumTwigBracelet[] = _("{PLAYER} put away the {STR_VAR_2}.\nWild pokémon will no longer be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Var1AndYouWantedVar2[] = _("You want {STR_VAR_2}?\nThat will be ¥{STR_VAR_3}.");
...
const u8 gText_AnythingElseICanHelp[] = _("Is there anything else I can do for you?");
const u8 gText_CanIHelpWithAnythingElse[] = _("Can I get you anything else?");
...
const u8 gText_Mailbox[] = _("Mail Box");
...
const u8 gText_TypesOfContests[] = _("Types of contest");
...
const u8 gText_ThatsYourLastPkmn[] = _("You need that pokémon!");
...
const u8 gText_Profile[] = _("Pofile");
...
const u8 gText_ContinueMenuTimeMorning[] = _("Morning");
const u8 gText_ContinueMenuTimeAfternoon[] = _("Afternoon");
const u8 gText_ContinueMenuTimeNight[] = _("Night");
...
ALIGNED(4) const u8 gText_RecordsOpenLevel[] = _("Opon Level");
...
const u8 gText_WeatherMenu[] = _("{STR_VAR_1}\n{STR_VAR_3}");

const u8 gText_WeatherMenuSunny[] = _("Sunny");
const u8 gText_WeatherMenuOvercast[] = _("Overcast");
const u8 gText_WeatherMenuNight[] = _("Clear Sky");
const u8 gText_WeatherMenuRain[] = _("Rain");
const u8 gText_WeatherMenuThunderstorm[] = _("Thunderstorm");
const u8 gText_WeatherMenuHarshSunlight[] = _("Harsh Sunlight");
const u8 gText_WeatherMenuSandstorm[] = _("Sandstorm");
const u8 gText_WeatherMenuHail[] = _("Hail");
...
ALIGNED(4) const u8 gText_MysteryGift[] = _("Myster Gift");
...
const u8 gText_MayBrendanMatchCallDesc[] = _("Rad Rival");
...
const u8 gText_WinonaMatchCallDesc[] = _("Sly Tamer");
...
const u8 gText_MartBalls[] = _("Poké Balls");
const u8 gText_MartMedicine[] = _("Medicine");
const u8 gText_MartBattleItems[] = _("Battle Items");
const u8 gText_MartBerries[] = _("Berries");
