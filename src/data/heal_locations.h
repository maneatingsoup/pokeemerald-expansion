static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SERAFEW - 1] = {MAP_GROUP(SERAFEW), MAP_NUM(SERAFEW), 18, 14},
    [HEAL_LOCATION_SERAFEW_PLAYER_HOUSE_2F - 1] = {MAP_GROUP(SERAFEW_PLAYER_HOUSE_2F), MAP_NUM(SERAFEW_PLAYER_HOUSE_2F), 1, 4},
    [HEAL_LOCATION_ALDUS - 1] = {MAP_GROUP(ALDUS), MAP_NUM(ALDUS), 16, 15},
    [HEAL_LOCATION_OSTIA - 1] = {MAP_GROUP(OSTIA), MAP_NUM(OSTIA), 33, 33},
    [HEAL_LOCATION_VALNI - 1] = {MAP_GROUP(VALNI), MAP_NUM(VALNI), 10, 18},
    [HEAL_LOCATION_PORT_NELERAS - 1] = {MAP_GROUP(PORT_NELERAS), MAP_NUM(PORT_NELERAS), 8, 13},
};
