...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_LUSTER_PURGE] =
    {
        .name = COMPOUND_STRING("Mystic Power"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Charge Drain", "Parabolic Charge"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PETAL_BLIZZARD] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Petal Storm", "Petal Blizzard"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Charming Cry", "Disarming Voice"),
        .description = COMPOUND_STRING(
            "Lets out a playful cry\n"
            "that cannot be evaded."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_FAIRY,
    ...
    [MOVE_GRASSY_TERRAIN] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Overgrowth", "Overgrowth"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MISTY_TERRAIN] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Fairy Mist", "Misty Terrain"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_KINGS_SHIELD] =
    {
        .name = COMPOUND_STRING("Force Shield"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Surge", "Electric Terrain"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DAZZLING_GLEAM] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Gleam Burst", "Dazzling Gleam"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Paleoblades", "Precipice Blades"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BANEFUL_BUNKER] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Toxic Bunker", "Baneful Bunker"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPIRIT_SHACKLE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Soul Shackle", "Spirit Shackle"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPARKLING_ARIA] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Sparkly Aria", "Sparkling Aria"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FLORAL_HEALING] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Floral Heal", "Floral Healing"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("HiHorsepower", "High Horsepower"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Weird", "Psychic Terrain"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Scale Clang", "Clanging Scales"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Raging Stomp", "Stomping Tantrum"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Iron Duobash", "Double Iron Bash"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BREAKING_SWIPE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Tail Swipe", "Breaking Swipe"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("KowtowCleave", "False Surrender"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Force Wave", "Expanding Force"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("MistExplsion", "Misty Explosion"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_RISING_VOLTAGE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("High Voltage", "Rising Voltage"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Rancor Burn", "Burning Jealousy"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Sand Scorch", "Scorching Sands"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ASTRAL_BARRAGE] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("AstralStrike", "Astral Barrage"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CHILLING_WATER] =
    {
        .name = HANDLE_EXPANDED_MOVE_NAME("Arctic Water", "Chilling Water"),
        .description = COMPOUND_STRING(
