...
static const u8 sEvolutionStoneDesc[] = _("A stone that makes\n"
                                          "a certain type of\n"
                                          "Pokémon evolve.");
...
// Apricorns
    ...
    [ITEM_ARUM_TWIG] =
    {
        ...
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_ArumTwigBracelet,
    },
