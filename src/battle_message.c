...
static const u8 sText_CantRun[] = _("You can't run from that pokémon!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_CANTRUN - BATTLESTRINGS_TABLE_START] = sText_CantRun,
};
...
const u16 gNoEscapeStringIds[] =
{
    ...
    [B_MSG_CANT_RUN]             = STRINGID_CANTRUN
};
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_NIGHT]              = STRINGID_ITISRAINING
};
