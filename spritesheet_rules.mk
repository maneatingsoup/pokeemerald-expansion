...
$(OBJEVENTGFXDIR)/people/team_helix/helix_member_m.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/team_helix/helix_member_f.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/gym_leaders/aviana.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
