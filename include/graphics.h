...
//genes
extern const u32 gItemIconPalette_FlameGene[];
extern const u32 gItemIconPalette_SplashGene[];
extern const u32 gItemIconPalette_ZapGene[];
extern const u32 gItemIconPalette_MeadowGene[];
extern const u32 gItemIconPalette_IcicleGene[];
extern const u32 gItemIconPalette_FistGene[];
extern const u32 gItemIconPalette_ToxicGene[];
extern const u32 gItemIconPalette_EarthGene[];
extern const u32 gItemIconPalette_SkyGene[];
extern const u32 gItemIconPalette_MindGene[];
extern const u32 gItemIconPalette_InsectGene[];
extern const u32 gItemIconPalette_StoneGene[];
extern const u32 gItemIconPalette_SpookyGene[];
extern const u32 gItemIconPalette_DracoGene[];
extern const u32 gItemIconPalette_DreadGene[];
extern const u32 gItemIconPalette_IronGene[];
extern const u32 gItemIconPalette_PixieGene[];
extern const u32 gItemIconPalette_BlankGene[];
// Drives
