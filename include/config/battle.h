...
#define B_STEEL_RESISTANCES         GEN_5 // In Gen6+, Steel-type Pokémon are no longer resistant to Dark-type and Ghost-type moves.
...
#define B_ROOST_PURE_FLYING         GEN_5 // In Gen5+, Roost makes pure Flying-types into Normal-type.
...
#define B_RECALC_TURN_AFTER_ACTIONS GEN_5 // In Gen8, switching/using a move affects the current turn's order of actions, better known as dynamic speed.
...
#define B_SHEER_COLD_ACC            GEN_5 // In Gen7+, Sheer Cold's base chance of hitting is reduced to 20% if the user isn't Ice-typed.
...
// Other move settings
#define B_INCINERATE_GEMS           GEN_5 // In Gen6+, Incinerate can destroy Gems.
